...
def load_initial():
    create_database('housing_market',host=my_aws_endpoint)
    ...
    create_table('housing_market','city',variables_city,host=my_aws_endpoint)
    load_data(os.path.join(os.getcwd(),'datasets','cities.csv'),'housing_market','city',host=my_aws_endpoint)
    add_fk('State','housing_market','city','state_code','foreign_state_code_city',host=my_aws_endpoint)


    variables = 'State VARCHAR(25) NOT NULL,StateName VARCHAR(255) NOT NULL,PRIMARY KEY(State)'
    create_table('housing_market','state_code',variables,host=my_aws_endpoint)
    load_data(os.path.join(os.getcwd(),'datasets','states_id.csv'),'housing_market','state_code',host=my_aws_endpoint)
    ...
    create_table('housing_market','listing_price',variables_listing_prices,host=my_aws_endpoint)
    add_fk('IdCity','housing_market','listing_price','city','foreign_IdCity_listing_price',host=my_aws_endpoint)
    ...
    create_table('housing_market','rental_price',variables_rental_prices,host=my_aws_endpoint)
    add_fk('IdCity','housing_market','rental_price','city','foreign_IdCity_rental_price',host=my_aws_endpoint)
    ...
    create_table('housing_market','crime_rate',variables_crime_rate,host=my_aws_endpoint)
    add_fk('State','housing_market','crime_rate','state_code','foreign_state_code_crime_rate',host=my_aws_endpoint)
    ...
    create_table('housing_market','sells_inventory',variables,host=my_aws_endpoint)
    add_fk('IdCity','housing_market','sells_inventory','city','foreign_IdCity_sells_inventory',host=my_aws_endpoint)
    ...
    create_table('housing_market','price_drops',variables,host=my_aws_endpoint)
    add_fk('IdCity','housing_market','price_drops','city','foreign_IdCity_price_drops',host=my_aws_endpoint)
    ...
    create_table('housing_market','weather_event',variables,host=my_aws_endpoint)
    add_fk('IdCity','housing_market','weather_event','city','foreign_IdCity_weather_event',host=my_aws_endpoint)
