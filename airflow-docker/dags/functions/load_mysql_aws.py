...
def load_initial():
    ...
    create_table('housing_market','calendar',variables,host=my_aws_endpoint,user='admin')
    load_data(os.path.join(os.getcwd(),'..','_clean_data','calendar.csv'),'housing_market','calendar',host=my_aws_endpoint,user='admin')
    ...
    add_fk('Date','housing_market','listing_price','calendar','foreign_Date_listing_price',host=my_aws_endpoint,user='admin')
    ...
    add_fk('Date','housing_market','rental_price','calendar','foreign_Date_rental_price',host=my_aws_endpoint,user='admin')
    ...
    add_fk('PeriodBegin','housing_market','sells_inventory','calendar','foreign_date_period_begin',column_name_parent='Date',host=my_aws_endpoint,user='admin')
    ...
    add_fk('PeriodBegin','housing_market','price_drops','calendar','price_drops_date_period_begin',column_name_parent='Date',host=my_aws_endpoint,user='admin')
